                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><a onclick="return confirm('Bạn có muốn sửa sinh viên này không?');" href="sua.php? edit=<?php echo $r['id'];?>">
                                ...
                                <a onclick="return confirm('Bạn có muốn xóa sinh viên này không?');" href="xoa.php? delete=<?php echo $r['id'];?>">
